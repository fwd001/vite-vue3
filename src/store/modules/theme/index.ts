...
import { initThemeSettings, setThemeSettings, clearThemeSettings } from './helpers'
...
export const useThemeStore = defineStore('theme-store', {
  ...
  actions: {
    ...
    /** 设置头部导航栏可见 */
    setHeaderNavbarVisible(visible: boolean) {
      this.header.navbar.visible = visible
    },
    /** 设置头部导航栏图标可见 */
    setHeaderNavbarIconVisible(visible: boolean) {
      this.header.navbar.showIcon = visible
    },
    /** 设置多页签可见 */
